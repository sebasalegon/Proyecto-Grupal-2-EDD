 ...
 * @author jesus
 */
public class GraphStreamLista extends javax.swing.JFrame implements ViewerListener {
     ...
     */
    public GraphStreamLista(ArbolFamiliar tree, String nombreCompleto) {
        this.tree = tree;
        initComponents();
        ...
        populateGraph(tree.root, 0, 0, tree.mostrarAntepasados(nombreCompleto));

        PumpViewer();

    }

    private void populateGraph(NodoFT nodo, int x, int y, ListaSimple nodos) {
        if (nodo == null) {
            return;
        }else if(nodos.buscar(nodo.integrante.nombreCompleto) == null){
            return;
        }
        try{
        ...
        if (nodo.sons != null) {
            ...
            for (NodoFT hijo : nodo.sons) {
                populateGraph(hijo, childX, childY, nodos);
                childX += 200;
            }
        }} catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GraphStreamLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GraphStreamLista(tree, nombreCompleto).setVisible(true);
            }
        });
    }
